package com.widyawacana.nontonskuy.ui.presentasion.splash
    ...
    Surface(
        ...
        Column(
            ...
            val image = if (isDarkMode) {
                R.drawable.img_logo_nontonskuy
            } else {
                R.drawable.img_logo_nontonskuy
            }
            Image(painter = painterResource(id = image), contentDescription = null, modifier = Modifier.height(100.dp))
        }
    }
}